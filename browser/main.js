...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-PUX4I2HI.js").then((m) => m);
...
var DynamicDelegationRenderer = class {
  ...
  listen(target, eventName, callback2, options) {
    if (this.shouldReplay(eventName)) {
      this.replay.push((renderer) => renderer.listen(target, eventName, callback2, options));
    }
...
var appRoutes = [
  ...
  { path: "auth", loadChildren: () => import("./chunk-VX6LI3RA.js") },
