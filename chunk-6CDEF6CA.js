...
var organizationchart_default2 = {
  root: {
    gutter: "0.75rem",
    transitionDuration: "{transition.duration}"
  },
...
var lara_default = __spreadProps(__spreadValues({}, base_default2), {
  components: {
    accordion: accordion_default2,
    autocomplete: autocomplete_default2,
    avatar: avatar_default2,
    badge: badge_default2,
    blockui: blockui_default2,
    breadcrumb: breadcrumb_default2,
    button: button_default2,
    datepicker: datepicker_default2,
    card: card_default2,
    carousel: carousel_default2,
    cascadeselect: cascadeselect_default2,
    checkbox: checkbox_default2,
    chip: chip_default2,
    colorpicker: colorpicker_default2,
    confirmdialog: confirmdialog_default2,
    confirmpopup: confirmpopup_default2,
    contextmenu: contextmenu_default2,
    dataview: dataview_default2,
    datatable: datatable_default2,
    dialog: dialog_default2,
    divider: divider_default2,
    dock: dock_default2,
    drawer: drawer_default2,
    editor: editor_default2,
    fieldset: fieldset_default2,
    fileupload: fileupload_default2,
    iftalabel: iftalabel_default2,
    floatlabel: floatlabel_default2,
    galleria: galleria_default2,
    iconfield: iconfield_default2,
    image: image_default2,
    imagecompare: imagecompare_default2,
    inlinemessage: inlinemessage_default2,
    inplace: inplace_default2,
    inputchips: inputchips_default2,
    inputgroup: inputgroup_default2,
    inputnumber: inputnumber_default2,
    inputotp: inputotp_default2,
    inputtext: inputtext_default2,
    knob: knob_default2,
    listbox: listbox_default2,
    megamenu: megamenu_default2,
    menu: menu_default2,
    menubar: menubar_default2,
    message: message_default2,
    metergroup: metergroup_default2,
    multiselect: multiselect_default2,
    orderlist: orderlist_default2,
    organizationchart: organizationchart_default2,
    overlaybadge: overlaybadge_default2,
    popover: popover_default2,
    paginator: paginator_default2,
    password: password_default2,
    panel: panel_default2,
    panelmenu: panelmenu_default2,
    picklist: picklist_default2,
    progressbar: progressbar_default2,
    progressspinner: progressspinner_default2,
    radiobutton: radiobutton_default2,
    rating: rating_default2,
    scrollpanel: scrollpanel_default2,
    select: select_default2,
    selectbutton: selectbutton_default2,
    skeleton: skeleton_default2,
    slider: slider_default2,
    speeddial: speeddial_default2,
    splitter: splitter_default2,
    splitbutton: splitbutton_default2,
    stepper: stepper_default2,
    steps: steps_default2,
    tabmenu: tabmenu_default2,
    tabs: tabs_default2,
    tabview: tabview_default2,
    textarea: textarea_default2,
    tieredmenu: tieredmenu_default2,
    tag: tag_default2,
    terminal: terminal_default2,
    timeline: timeline_default2,
    togglebutton: togglebutton_default2,
    toggleswitch: toggleswitch_default2,
    tree: tree_default2,
    treeselect: treeselect_default2,
    treetable: treetable_default2,
    toast: toast_default2,
    toolbar: toolbar_default2,
    virtualscroller: virtualscroller_default2,
    tooltip: tooltip_default2,
    ripple: ripple_default2
  }
});
...
var organizationchart_default3 = {
  root: {
    gutter: "0.75rem",
    transitionDuration: "{transition.duration}"
  },
...
var nora_default = __spreadProps(__spreadValues({}, base_default3), {
  components: {
    accordion: accordion_default3,
    autocomplete: autocomplete_default3,
    avatar: avatar_default3,
    badge: badge_default3,
    blockui: blockui_default3,
    breadcrumb: breadcrumb_default3,
    button: button_default3,
    datepicker: datepicker_default3,
    card: card_default3,
    carousel: carousel_default3,
    cascadeselect: cascadeselect_default3,
    checkbox: checkbox_default3,
    chip: chip_default3,
    colorpicker: colorpicker_default3,
    confirmdialog: confirmdialog_default3,
    confirmpopup: confirmpopup_default3,
    contextmenu: contextmenu_default3,
    dataview: dataview_default3,
    datatable: datatable_default3,
    dialog: dialog_default3,
    divider: divider_default3,
    dock: dock_default3,
    drawer: drawer_default3,
    editor: editor_default3,
    fieldset: fieldset_default3,
    fileupload: fileupload_default3,
    iftalabel: iftalabel_default3,
    floatlabel: floatlabel_default3,
    galleria: galleria_default3,
    iconfield: iconfield_default3,
    image: image_default3,
    imagecompare: imagecompare_default3,
    inlinemessage: inlinemessage_default3,
    inplace: inplace_default3,
    inputchips: inputchips_default3,
    inputgroup: inputgroup_default3,
    inputnumber: inputnumber_default3,
    inputotp: inputotp_default3,
    inputtext: inputtext_default3,
    knob: knob_default3,
    listbox: listbox_default3,
    megamenu: megamenu_default3,
    menu: menu_default3,
    menubar: menubar_default3,
    message: message_default3,
    metergroup: metergroup_default3,
    multiselect: multiselect_default3,
    orderlist: orderlist_default3,
    organizationchart: organizationchart_default3,
    overlaybadge: overlaybadge_default3,
    popover: popover_default3,
    paginator: paginator_default3,
    password: password_default3,
    panel: panel_default3,
    panelmenu: panelmenu_default3,
    picklist: picklist_default3,
    progressbar: progressbar_default3,
    progressspinner: progressspinner_default3,
    radiobutton: radiobutton_default3,
    rating: rating_default3,
    scrollpanel: scrollpanel_default3,
    select: select_default3,
    selectbutton: selectbutton_default3,
    skeleton: skeleton_default3,
    slider: slider_default3,
    speeddial: speeddial_default3,
    splitter: splitter_default3,
    splitbutton: splitbutton_default3,
    stepper: stepper_default3,
    steps: steps_default3,
    tabmenu: tabmenu_default3,
    tabs: tabs_default3,
    tabview: tabview_default3,
    textarea: textarea_default3,
    tieredmenu: tieredmenu_default3,
    tag: tag_default3,
    terminal: terminal_default3,
    timeline: timeline_default3,
    toast: toast_default3,
    togglebutton: togglebutton_default3,
    toggleswitch: toggleswitch_default3,
    toolbar: toolbar_default3,
    tooltip: tooltip_default3,
    tree: tree_default3,
    treeselect: treeselect_default3,
    treetable: treetable_default3,
    virtualscroller: virtualscroller_default3,
    ripple: ripple_default3
  }
});
...
function AppConfigurator_For_12_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275styleMap(\u0275\u0275pureFunction1(4, _c0, (surface_r5 == null ? null : surface_r5.name) === "noir" ? "var(--text-color)" : surface_r5 == null ? null : surface_r5.palette == null ? null : surface_r5.palette["500"]));
...
function AppConfigurator_div_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 4)(1, "span", 1);
    \u0275\u0275text(2, "Menu Mode");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p-selectbutton", 8);
...
var AppConfigurator = class _AppConfigurator {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppConfigurator, selectors: [["app-configurator"]], hostAttrs: [1, "hidden", "absolute", "top-[3.25rem]", "right-0", "w-72", "p-4", "bg-surface-0", "dark:bg-surface-900", "border", "border-surface", "rounded-border", "origin-top", "shadow-[0px_3px_5px_rgba(0,0,0,0.02),0px_0px_2px_rgba(0,0,0,0.05),0px_1px_4px_rgba(0,0,0,0.08)]"], decls: 18, vars: 4, consts: [[1, "flex", "flex-col", "gap-4"], [1, "text-sm", "text-muted-color", "font-semibold"], [1, "pt-2", "flex", "gap-2", "flex-wrap", "justify-start"], ["type", "button", 1, "border-none", "w-5", "h-5", "rounded-full", "p-0", "cursor-pointer", "outline-none", "outline-offset-1", 3, "title", "ngClass", "style"], [1, "flex", "flex-col", "gap-2"], ["size", "small", 3, "ngModelChange", "options", "ngModel", "allowEmpty"], ["class", "flex flex-col gap-2", 4, "ngIf"], ["type", "button", 1, "border-none", "w-5", "h-5", "rounded-full", "p-0", "cursor-pointer", "outline-none", "outline-offset-1", 3, "click", "title", "ngClass"], ["size", "small", 3, "ngModelChange", "ngModel", "options", "allowEmpty"]], template: function AppConfigurator_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(11, AppConfigurator_For_12_Template, 1, 8, "button", 3, _forTrack0);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(13, "div", 4)(14, "span", 1);
      \u0275\u0275text(15, "Presets");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(16, "p-selectbutton", 5);
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275template(17, AppConfigurator_div_17_Template, 4, 3, "div", 6);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(5);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppConfigurator, { className: "AppConfigurator", filePath: "src/app/layout/component/app.configurator.ts", lineNumber: 93 });
})();
...
var AppFloatingConfigurator = class _AppFloatingConfigurator {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppFloatingConfigurator, selectors: [["app-floating-configurator"]], decls: 5, vars: 3, consts: [[1, "fixed", "flex", "gap-4", "top-8", "right-8"], ["type", "button", "severity", "secondary", 3, "onClick", "rounded", "icon"], [1, "relative"], ["icon", "pi pi-palette", "pStyleClass", "@next", "enterFromClass", "hidden", "enterActiveClass", "animate-scalein", "leaveToClass", "hidden", "leaveActiveClass", "animate-fadeout", "type", "button", "rounded", "", 3, "hideOnOutsideClick"]], template: function AppFloatingConfigurator_Template(rf, ctx) {
    if (rf & 1) {
  ...
  }, dependencies: [ButtonModule, Button, StyleClassModule, StyleClass, AppConfigurator], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppFloatingConfigurator, { className: "AppFloatingConfigurator", filePath: "src/app/layout/component/app.floatingconfigurator.ts", lineNumber: 20 });
})();
...
//# sourceMappingURL=chunk-6CDEF6CA.js.map
